...
// MessageText:
//
// %1!-15s! List all device setup classes.
//
...
// MessageText:
//
// %1!-15s! List all devices in a setup class.
//
...
// For IDs with '&', either add '^' before (USB\VID_0000^&PID_0000) or put the ID between "" ("USB\VID_0000&PID_0000").
// Device entries have the format <instance>: <descr>
...
// MessageText:
//
// %1!-15s! Find devices, including those that are not currently attached.
//
...
// MessageText:
//
// %1!-15s! List running status of devices.
//
...
// MessageText:
//
// %1!-15s! List installed driver files for devices.
//
...
// MessageText:
//
// %1!-15s! List hardware resources for devices.
//
...
// MessageText:
//
// %1!-15s! List hardware IDs of devices.
//
...
// MessageText:
//
// %1!-15s! List expected driver stack for devices.
//
#define MSG_STACK_SHORT                  0x0000EC01L

//
// MessageId: MSG_STATUSEX_LONG
//
// MessageText:
//
// Devcon Extended Status Command
// Lists the status, hardware resources, setup classes, driver stack, hardware IDs and driver nodes of devices with the specified hardware or instance ID.
// Valid on local and remote computers.
// %1 [-m:\\<machine>] %2 <id> [<id>...]
// %1 [-m:\\<machine>] %2 =<class> [<id>...]
// <machine>    Specifies a remote computer.
...
// For IDs with '&', either add '^' before (USB\VID_0000^&PID_0000) or put the ID between "" ("USB\VID_0000&PID_0000").
//
#define MSG_STATUSEX_LONG                0x0000EC02L

//
// MessageId: MSG_STATUSEX_SHORT
//
// MessageText:
//
// %1!-15s! Lists the status, hardware resources, setup classes, driver stack, hardware IDs and driver nodes of devices.
//
#define MSG_STATUSEX_SHORT               0x0000EC03L
...
// MessageText:
//
// No devices were enabled, either because the devices were not found, or because the devices could not be enabled.
//
...
// MessageText:
//
// The %1!u! device(s) are ready to be enabled. To enable the devices, restart the devices or reboot the system .
//
...
// MessageText:
//
// No devices were disabled, either because the devices were not found, or because the devices could not be disabled.
//
...
// MessageText:
//
// The %1!u! device(s) are ready to be disabled. To disable the devices, restart the devices or reboot the system .
//
...
// MessageText:
//
// No devices were restarted, either because the devices were not found, or because the devices could not be restarted.
//
...
// MessageText:
//
// %1!-15s! Reboot the local computer.
//
...
// MessageText:
//
// %1!-15s! Install a device manually.
//
...
// MessageText:
//
// %1!-15s! Update a device manually.
//
...
// MessageText:
//
// %1!-15s! Manually update a device (non interactive).
//
...
// <inf> is a full path to the INF of the Driver Package that will be installed on this machine.
//
...
// MessageText:
//
// %1!-15s! Adds (installs) a third-party (OEM) driver package.
//
...
// This command will only work on the local machine.
// [-f] will force delete the driver package, even if it is in use by a device.
// <inf> is the name of a published INF on the local machine.  This is the value returned from dp_add and dp_enum.
//
...
// MessageText:
//
// %1!-15s! Deletes a third-party (OEM) driver package.
//
...
// MessageText:
//
// %1!-15s! Lists the third-party (OEM) driver packages installed on this machine.
//
...
// MessageText:
//
// %1!-15s! List driver nodes of devices.
//
...
// 
// To list the upper/lower filter drivers for a class, type:
// devcon classfilter <class> {upper | lower}
// 
// The Devcon classfilter command uses subcommands, which consist of an operator (=, @, -, +, !) and a filter driver name.
// 
// The Devcon classfilter command uses a virtual cursor to move through the list of filter drivers. The cursor starts at the beginning of the list (before the first filter). Unless returned to the starting position, the cursor always moves forward.
// 
// Operators
//  =       Move the cursor to the beginning of the filter driver list (before the first filter driver).
// 
//  @       Position the cursor on the next instance of the specified filter.
// 
//  -       Add before. Insert the specified filter before the filter on which the cursor is positioned. If the cursor is not positioned on a filter, insert the new filter at the beginning of the list. When the subcommand completes, the cursor is positioned on the newly-added filter.
// 
//  +       Add after. Insert the specified filter after the filter on which the cursor is positioned. If the cursor is not positioned on a filter, Devcon inserts the new filter at the end of the list. When the subcommand completes, the cursor cursor is positioned on the newly-added filter.       
// 
//  !       Deletes the next occurrence of the specified filter. When the subcommand completes, the cursor occupies the position of the deleted filter. Subsequent - or + subcommands insert a new filter at the cursor position.
// 
// 
// Examples:
...
// MessageText:
//
// %1!-15s! Add, delete, and reorder class filters.
//
...
// MessageText:
//
// %1!-15s! Modify Hardware ID's of listed root-enumerated devices.
//
